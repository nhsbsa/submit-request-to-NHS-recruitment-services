...
router.post('/v1/start-page', function (req, res) {
  ...
  res.redirect('/v1/before-you-start')
...
router.post('/v1/requestor-name', function (req, res) {
  ...
  if (requestorFirsttName && requestorLastName) {
    res.redirect('/v1/requestor-email-address')
  } else {
    res.redirect('/v1/requestor-name')
  }
...
router.post('/v1/requestor-email-address', function (req, res) {

  var requestorEmailAddress = req.session.data['requestorEmailAddress'];
